...
%	
\caption{Comparison of (a) shape error and (b) volume error of proposed method with existing approaches as the b-rep resolution is varied.}
\label{fig:graph1}
\end{figure}
\begin{figure}[ht!]
	\centering
	\includegraphics[scale=0.10]{media/7-performance/spheres-resolution.pdf}
	\caption{Comparison of proposed method with existing approaches for selected b-rep resolutions.}
	\label{fig:demos1}
\end{figure} \\
%
...
\begin{figure}[b!]
	...
	%	
	\caption{Comparison of (a) shape error and (b) volume error of proposed method with existing approaches as the sphere radius is varied.}
	\label{fig:graph2}
\end{figure}
\begin{figure}[ht!]
	\centering
	\includegraphics[scale=0.10]{media/7-performance/spheres-size.pdf}
	\caption{Comparison of proposed method with existing approaches for selected sphere radii.}
	\label{fig:demos2}
\end{figure}
...
\begin{figure}[b!]
	...
	%	
	\caption{Comparison of (a) shape error and (b) volume error of the proposed method with existing approaches as the sphere center is translated.}
	\label{fig:graph3}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[ht!]
	...
	\caption{Comparison of proposed method with existing approaches for selected mask noise.}
	\label{fig:demos2}
\end{figure}
\begin{figure}[h!]
	\centering
	...
	%	
	\caption{Comparison of (a) shape error and (b) volume error of the proposed method with existing approaches as noise near the mask boundary is increased.}
	\label{fig:graph4}
\end{figure}
