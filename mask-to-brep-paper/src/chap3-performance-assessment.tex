...
\begin{figure}[h!]
	\centering
	\subfigure[]{%
		\includegraphics[scale=0.115]{media/7-performance/14-examples-b.pdf}}\hspace{1.2cm}
	\subfigure[]{%
		\includegraphics[scale=0.115]{media/7-performance/14-examples-a.pdf}}
	...
	\caption{Image masks (green) and corresponding b-reps for commercial software (red) and proposed method (blue) for various examples from MRI and CT: (a) heart~\cite{cvgg}, (b) brain~\cite{marcus_2007}, (c) lungs~\cite{rikxoort_2009}, (d) distal femur~\cite{epperson_2013}, (e) skull~\cite{clark_2013}, (f) pelvis~\cite{clark_2013}, (g) L5 lumbar~\cite{yao_2016}, (h) upper left second molar (author's), (i) liver~\cite{bilic_2019}, and (j) example image with disjoint objects in image mask.}
